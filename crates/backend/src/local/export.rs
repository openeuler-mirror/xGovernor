use crate::local::backend::{file_name_string, io_error_for_path, LocalBackendState};
...
mod tests {
    ...
    use crate::local::policy::LocalBackendPolicy;
    use operation_protocol::BackendPath;
